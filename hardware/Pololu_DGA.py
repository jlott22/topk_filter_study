...
METRICS_LOG_FILE = "metrics-temp-DGA.txt"
...
# DGA allocator state
# -----------------------------
# Resource-bounded hardware DGA. This benchmark port uses a smaller population
# and generation count than the simulator; the metric hub now supplies the
# candidate working-set size through its Top-K configuration.
