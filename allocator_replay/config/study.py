...
RESULTS_ROOT = REPOSITORY_ROOT / "results" / "allocator_replay"
COHORT_ROOT = RESULTS_ROOT / "cohorts"
TRACE_ROOT = RESULTS_ROOT / "traces"
CAMPAIGN_ROOT = RESULTS_ROOT / "campaigns"
DEVICE_BUILD_ROOT = RESULTS_ROOT / "device_build"
BAYESIAN_SIM_ROOT = REPOSITORY_ROOT / "simulator"
COLLABORATIVE_SIM_ROOT = REPOSITORY_ROOT.parent / "dcta_benchmark_sim"
