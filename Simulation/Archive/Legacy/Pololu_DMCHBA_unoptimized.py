...
def _dmchba_candidate_cells():
    """Return simulator-style probability-first Top-K valid task cells."""
...
def _pick_task_cell_impl():
    ...
    best = None
    best_dist = 9999
    for cell in _dmchba_candidate_cells():
        d = manhattan(pos[0], pos[1], cell[0], cell[1])
        if d < best_dist:
            best_dist = d
            best = cell
    return best
