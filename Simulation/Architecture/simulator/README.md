...
`../../../Results/Simulation/Bayesian/<run-name>` to keep generated results separate from simulator
source.
...
`../../../Results/Simulation/Bayesian/primary_topk_campaign/scenario_manifest.json`
