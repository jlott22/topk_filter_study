...
DCTA_ROOT = REPO_ROOT.parent / "dcta_benchmark_sim"
RUN_ROOT = REPO_ROOT / "results" / "hil_aligned_simulation" / "missing_lowk_full_counts"
RECORDS_DIR = RUN_ROOT / "campaign_records"
RAW_ROOT = RUN_ROOT / "raw"
COMBINED_ROOT = RUN_ROOT / "combined"
REPORTS_ROOT = RUN_ROOT / "reports"

BAYESIAN_SCENARIO = REPO_ROOT / "simulator" / "scenarios" / "final_trial_500.csv"
            ...
            rows.append(
                {
                    ...
                    "out_dir": str(out_dir),
                    "working_directory": str(REPO_ROOT / "simulator"),
                    "weight": weight + cells,
